...
if __name__ == '__main__':
	...
	data = torch.zeros((1,3,244,244))
	#model_trt = torch2trt(model,[model.backbone[0].body.layer1[0].conv1.cuda()])#, fp16_mode=True)
	model_trt = torch2trt(model, [data]) #, fp16_mode=True

	print("saving optimized model")
	torch.save(model_trt.state_dict(), "outputs/optimized_trtmodel.pth")
